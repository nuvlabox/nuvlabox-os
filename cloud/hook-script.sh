...
mkdir -p "${ROOTFS}/opt/nuvlaedge"


install -m "+x" files/nuvlaedge-installer "${ROOTFS}/usr/local/bin/"
install -m "+r" files/sixsq.gpg_pubkey.bin "${ROOTFS}/opt/nuvlaedge/gpg_pubkey.bin"
